        ...
        <tbody>
          {rows.map((r) => (
            <tr key={r.name} className="align-top">
              <td className="border-b border-ink/7 py-3 pr-4 font-mono text-[12.5px] text-ink">
                {r.name}
              </td>
              <td className="border-b border-ink/7 py-3 pr-4 font-mono text-[12px] text-ink/70">
                {r.type}
              </td>
              <td className="border-b border-ink/7 py-3 pr-4 font-mono text-[12px] text-ink/62">
                {r.default ?? ""}
              </td>
