    ...
    <div className="grid grid-cols-2 gap-3">
      ...
      <div>
        ...
        <div className="relative">
          ...
          />
          <span className="pointer-events-none absolute right-3 top-1/2 -translate-y-1/2 font-sans text-[10.5px] text-ink/42">
            g
          </span>
        </div>
      </div>
      <p className="col-span-2 font-sans text-[11.5px] font-light text-ink/55 tabular-nums">
