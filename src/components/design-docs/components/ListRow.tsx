    ...
    >
      ...
      <SpecimenRow>
        <Specimen label="risky · caution · healthy · no price · draft · archived" flush>
          ...
          <ListRow
            ...
            meta="archived"
            value={
              <Button variant="link" className="text-label-bold" iconLeading={<RotateCcw size={13} strokeWidth={2.2} />}>
                Restore
              </Button>
            }
          />
      ...
      <SpecimenRow>
        ...
        <Specimen label='stripe="neutral" · dashboard attention list'>
          <ListRow emphasis="product" stripe="neutral" label="Artemis crescent studs" meta={<>Earrings · <Chip tone="neutral" size="sm">No price</Chip></>} value={<Button variant="link" className="text-label-bold" iconTrailing={<ChevronRight size={15} strokeWidth={2} />}>Set price</Button>} />
        </Specimen>
      </SpecimenRow>
      <PropsTable
        rows={[
