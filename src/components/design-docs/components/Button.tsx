    ...
    >
      ...
      <SpecimenRow>
        <Specimen label="navigates → trailing chevron" inline>
          <Button variant="link" className="text-label-bold" iconTrailing={<ChevronRight size={15} strokeWidth={2} />}>
            Reprice
          </Button>
        </Specimen>
        <Specimen label="acts in place → leading action icon" inline>
          <Button variant="link" className="text-label-bold" iconLeading={<Plus size={14} strokeWidth={2.2} />}>
            Add material
          </Button>
        </Specimen>
