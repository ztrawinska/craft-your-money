...
export function TypographyDoc() {
  ...
  return (
    <DocSection page
      ...
      title="Typography"
      spec="§1.4"
      lede="Twenty-four presets on eleven sizes. Lora for names, prices, numbers and the editorial sentences; IBM Plex Sans for UI text. Every line box is a multiple of 4px, so text stacks on the spacing rhythm. One class each: text-meta, text-figure-lg — plus font-serif or font-sans."
    >
          ...
          return (
            ...
            >
              <div className="font-sans">
                <p className="text-label-strong text-ink">{name} <span className="font-mono text-meta text-ink/62">text-{name}</span></p>
