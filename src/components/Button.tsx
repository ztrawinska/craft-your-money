...
const variantClass: Record<ButtonVariant, string> = {
  primary:
    "block w-full text-center rounded-button px-4 py-3 min-h-tap text-button  bg-clay-deep text-on-clay shadow-[0_1px_2px_rgba(138,90,82,0.3)]",
  ghost:
    "block w-full text-center rounded-button px-4 py-3 min-h-tap text-button-ghost  border border-ink/14 text-ink/62",
